        ...
        <nav className="shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex-shrink-0 text-xl">Fasco</div>
                    <div className="hidden md:flex space-x-4">
                        <ScrollLink to="home" smooth={true} duration={500} className="px-3 py-2 rounded-md text-sm font-medium"> Home </ScrollLink>
                        <ScrollLink to="about" smooth={true} duration={500} className="px-3 py-2 rounded-md text-sm font-medium hover:underline"> Deals </ScrollLink>
